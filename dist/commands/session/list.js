...
export function registerSessionListCommand(sessionCmd) {
    sessionCmd
        .command("list")
        ...
        try {
            ...
            const resp = await client.getJson(`/api/sessions${qs ? `?${qs}` : ""}`);
            ...
            outputData(sessions, outputFormat, ["ID", "Agent", "Title", "Status", "Updated"], sessions.map((s) => [
